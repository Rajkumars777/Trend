...
const MOCK_CROP_RISKS = [
    { name: "Rice", risk: "Low", disease: "None", yieldTrend: "stable" },
    { name: "Wheat", risk: "Medium", disease: "Rust", yieldTrend: "down" },
    { name: "Cotton", risk: "High", disease: "Bollworm", yieldTrend: "down" },
    { name: "Soybean", risk: "Low", disease: "None", yieldTrend: "up" },
    { name: "Corn", risk: "Medium", disease: "Drought", yieldTrend: "stable" }
];

export default function CropDeepDive() {
    return (
